...
import py.com.uber.admin.services.RolesService;
...
public class RolesRESTController {
	...
	public ResponseEntity <?> listarPaginado(@RequestBody PaginadoParam<Roles> param){
		try {
			PaginadoResult<Roles> lista = service.listar(param);
	...
	@PostMapping(path="/")
	public  ResponseEntity <?> agregarRecurso (@RequestBody Roles param){
		Respuesta<Roles> respuesta = new Respuesta<>();

		try {
			Roles dato = service.guardar(param);
	...
	@PutMapping(path="/{id}")
	public  ResponseEntity <?> modificarRecurso (@PathVariable("id")Integer id ,  @RequestBody Roles param){
		Respuesta<Roles> respuesta = new Respuesta<>();

		try {
			Roles dato = service.modificar(param,id);
			respuesta.setDato(dato);
	...
	public  ResponseEntity <?> descativar (@PathVariable("id")Integer id ){
		...
		try {
			Roles dato = service.desactivar(id);
			respuesta.setDato(dato);
	...
	public  ResponseEntity <?> listar ( ){
		Respuesta<List<Roles> > respuesta = new Respuesta<>();
		List<Roles> dato = new ArrayList<Roles>();
		try {
			dato = service.listar();
			System.out.println(dato);
			if(dato==null) {
